...
///////////////////////////////////////////////////////////////////
// Date: 2014/5/14                                               //
// Running corresponding model (FPMC)                            //
///////////////////////////////////////////////////////////////////
...
int main(int argc, char **argv) {
    ...
    string submission_path = "/home/anthonylife/Doctor/Code/MyPaperCode/NextLocation/results/FPMC_Result.dat";
    string user_factor_path = "/home/anthonylife/Doctor/Code/MyPaperCode/NextLocation/src/FPMC_C/user_factor.model";
    string poi_factor_path = "/home/anthonylife/Doctor/Code/MyPaperCode/NextLocation/src/FPMC_C/poi_factor.model";
    string poi_bias_path = "/home/anthonylife/Doctor/Code/MyPaperCode/NextLocation/src/FPMC_C/poi_bias.model";
    ...
    FPMC *fpmc = new FPMC((char *)trdata_path.c_str(),
    ...
    if (restart_tag)
        fpmc->train();
    fpmc->recommendationNewPOI((char *)submission_path.c_str());
