...
///////////////////////////////////////////////////////////////////
// Date: 2014/5/14                                               //
// Running corresponding model (SFPMC)                           //
///////////////////////////////////////////////////////////////////
...
string FRIEND_SUFFIX[3] = {"Brightkite_Friend_Simval.csv",
            "Gowalla1_Friend_Simval.csv", "Gowalla2_Friend_Simval.csv"};
...
int main(int argc, char **argv) {
    ...
    string submission_path = "/home/anthonylife/Doctor/Code/MyPaperCode/NextLocation/results/SFPMC_Result.dat";
    string user_factor_path = "./user_factor.model";
    string poi_factor_path = "./poi_factor.model";
    string poi_bias_path = "./poi_bias.model";
    ...
    string frienddata_path = DATA_ROOT_PATH + FRIEND_SUFFIX[a];
    ...
    SFPMC *sfpmc = new SFPMC((char *)trdata_path.c_str(),
                             (char *)vadata_path.c_str(),
                             (char *)tedata_path.c_str(),
                             (char *)frienddata_path.c_str(),
    ...
    if (restart_tag)
        sfpmc->train();
    sfpmc->recommendationNewPOI((char *)submission_path.c_str());
